...
class CacheManager:
    ...
    def get(self, database: str, collection: str) -> CacheEntry | None:
    ...
    def invalidate(self, database: str | None = None, collection: str | None = None) -> None:
        """
...
def invalidate_cache_on_refresh(database: str | None = None, collection: str | None = None) -> None:
