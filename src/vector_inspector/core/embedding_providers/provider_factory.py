...
class ProviderFactory:
    ...
    @classmethod
    def create(cls, model_name: str, model_type: str | None = None, **kwargs) -> EmbeddingProvider:
...
def create_provider(model_name: str, model_type: str | None = None, **kwargs) -> EmbeddingProvider:
